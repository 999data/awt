<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrudApplication.aspx.cs" Inherits="DBCrudOperationDisconnectedApp.CrudApplication" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <center>
                <h3>Crud Application using Disconnected Architecture</h3>
